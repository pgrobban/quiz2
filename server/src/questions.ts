...
export const MATCHING_BANK: MatchingBoardBankItem[] = [
  {
    ...
    pairs: [
      ...
      {
        left: { id: "m0-l3", text: "Michael Jackson" },
        right: { id: "m0-r3", text: "Thriller" },
      },
      {
        left: { id: "m0-l4", text: "Nirvana" },
        right: { id: "m0-r4", text: "Smells Like Teen Spirit" },
      },
      {
        left: { id: "m0-l5", text: "Whitney Houston" },
        right: { id: "m0-r5", text: "I Will Always Love You" },
      },
      {
        left: { id: "m0-l6", text: "The Beatles" },
        right: { id: "m0-r6", text: "Hey Jude" },
      },
      {
        left: { id: "m0-l7", text: "Adele" },
        right: { id: "m0-r7", text: "Rolling in the Deep" },
      },
      {
        left: { id: "m0-l8", text: "Elton John" },
        right: { id: "m0-r8", text: "Rocket Man" },
      },
      {
        left: { id: "m0-l9", text: "Survivor" },
        right: { id: "m0-r9", text: "Eye of the Tiger" },
      },
      {
        left: { id: "m0-l10", text: "a-ha" },
        right: { id: "m0-r10", text: "Take On Me" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m0-l1", text: "Line 1" },
        right: { id: "m0-r1", text: "White" },
      },
      {
        left: { id: "m0-l2", text: "Line 2" },
        right: { id: "m0-r2", text: "Yellow" },
      },
      {
        left: { id: "m0-l3", text: "Line 3" },
        right: { id: "m0-r3", text: "Dark blue" },
      },
      {
        left: { id: "m0-l4", text: "Line 4" },
        right: { id: "m0-r4", text: "Dark green" },
      },
      {
        left: { id: "m0-l5", text: "Line 5" },
        right: { id: "m0-r5", text: "Red" },
      },
      {
        left: { id: "m0-l6", text: "Line 6" },
        right: { id: "m0-r6", text: "Orange" },
      },
      {
        left: { id: "m0-l7", text: "Line 7" },
        right: { id: "m0-r7", text: "Brown" },
      },
      {
        left: { id: "m0-l8", text: "Line 8" },
        right: { id: "m0-r8", text: "Purple" },
      },
      {
        left: { id: "m0-l9", text: "Line 9" },
        right: { id: "m0-r9", text: "Light blue" },
      },
      {
        left: { id: "m0-l10", text: "Line 10" },
        right: { id: "m0-r10", text: "Light green" },
      },
    ],
    keepLeftOrder: true,
  },
  {
    ...
    pairs: [
      {
        left: { id: "m1-l1", text: "Fontana di Trevi" },
        right: { id: "m1-r1", text: "Rome" },
      },
      {
        left: { id: "m1-l2", text: "Forbidden City" },
        right: { id: "m1-r2", text: "Beijing" },
      },
      {
        left: { id: "m1-l3", text: "Sky Tree" },
        right: { id: "m1-r3", text: "Tokyo" },
      },
      {
        left: { id: "m1-l4", text: "Golden Gate Bridge" },
        right: { id: "m1-r4", text: "San Francisco" },
      },
      {
        left: { id: "m1-l5", text: "Gardens by the Bay" },
        right: { id: "m1-r5", text: "Singapore" },
      },
      {
        left: { id: "m1-l6", text: "Burj Khalifa" },
        right: { id: "m1-r6", text: "Dubai" },
      },
      {
        left: { id: "m1-l7", text: "Angkor Wat" },
        right: { id: "m1-r7", text: "Siem Reap" },
      },
      {
        left: { id: "m1-l8", text: "Great Pyramid" },
        right: { id: "m1-r8", text: "Giza" },
      },
      {
        left: { id: "m1-l9", text: "Kalemegdan" },
        right: { id: "m1-r9", text: "Belgrade" },
      },
      {
        left: { id: "m1-l10", text: "Brandenburg Gate" },
        right: { id: "m1-r10", text: "Berlin" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m2-l1", text: "George Orwell" },
        right: { id: "m2-r1", text: "Animal Farm" },
      },
      {
        left: { id: "m2-l2", text: "J.R.R. Tolkien" },
        right: { id: "m2-r2", text: "The Hobbit" },
      },
      {
        left: { id: "m2-l3", text: "Jane Austen" },
        right: { id: "m2-r3", text: "Pride and Prejudice" },
      },
      {
        left: { id: "m2-l4", text: "Mary Shelley" },
        right: { id: "m2-r4", text: "Frankenstein" },
      },
      {
        left: { id: "m2-l5", text: "Herman Melville" },
        right: { id: "m2-r5", text: "Moby-Dick" },
      },
      {
        left: { id: "m2-l6", text: "Harper Lee" },
        right: { id: "m2-r6", text: "To Kill a Mockingbird" },
      },
      {
        left: { id: "m2-l7", text: "Sun Tzu" },
        right: { id: "m2-r7", text: "The Art of War" },
      },
      {
        left: { id: "m2-l8", text: "Agatha Christie" },
        right: { id: "m2-r8", text: "Murder on the Orient Express" },
      },
      {
        left: { id: "m2-l9", text: "Franz Kafka" },
        right: { id: "m2-r9", text: "The Metamorphosis" },
      },
      {
        left: { id: "m2-l10", text: "Homer" },
        right: { id: "m2-r10", text: "The Odyssey" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m3-l1", text: "Leonardo DiCaprio" },
        right: { id: "m3-r1", text: "Inception" },
      },
      {
        left: { id: "m3-l2", text: "Robert Downey Jr." },
        right: { id: "m3-r2", text: "Iron Man" },
      },
      {
        left: { id: "m3-l3", text: "Scarlett Johansson" },
        right: { id: "m3-r3", text: "Lost in Translation" },
      },
      {
        left: { id: "m3-l4", text: "Robin Williams" },
        right: { id: "m3-r4", text: "Jumanji" },
      },
      {
        left: { id: "m3-l5", text: "Natalie Portman" },
        right: { id: "m3-r5", text: "Black Swan" },
      },
      {
        left: { id: "m3-l6", text: "Johnny Depp" },
        right: { id: "m3-r6", text: "Pirates of the Caribbean" },
      },
      {
        left: { id: "m3-l7", text: "Morgan Freeman" },
        right: { id: "m3-r7", text: "The Shawshank Redemption" },
      },
      {
        left: { id: "m3-l8", text: "Christian Bale" },
        right: { id: "m3-r8", text: "American Psycho" },
      },
      {
        left: { id: "m3-l9", text: "Margot Robbie" },
        right: { id: "m3-r9", text: "The Wolf of Wall Street" },
      },
      {
        left: { id: "m3-l10", text: "Brad Pitt" },
        right: { id: "m3-r10", text: "Fight Club" },
      },
    ],
  },
  {
    ...
    pairs: [
      ...
      {
        left: { id: "m4-l2", text: "Kaizer Chiefs" },
        right: { id: "m4-r2", text: "South Africa" },
      },
      {
        left: { id: "m4-l3", text: "Velez Sarsfield" },
        right: { id: "m4-r3", text: "Argentina" },
      },
      {
        left: { id: "m4-l4", text: "Kashima Antlers" },
        right: { id: "m4-r4", text: "Japan" },
      },
      {
        left: { id: "m4-l5", text: "Columbus Crew" },
        right: { id: "m4-r5", text: "USA" },
      },
      {
        left: { id: "m4-l6", text: "Crewe Alexandra" },
        right: { id: "m4-r6", text: "England" },
      },
      {
        left: { id: "m4-l7", text: "Atletico Mineiro" },
        right: { id: "m4-r7", text: "Brazil" },
      },
      {
        left: { id: "m4-l8", text: "Club Always Ready" },
        right: { id: "m4-r8", text: "Bolivia" },
      },
      {
        left: { id: "m4-l9", text: "Rayo Vallecano" },
        right: { id: "m4-r9", text: "Spain" },
      },
      {
        left: { id: "m4-l10", text: "Admira Wacker" },
        right: { id: "m4-r10", text: "Austria" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m5-l1", text: "Mitsubishi" },
        right: { id: "m5-r1", text: "Japan" },
      },
      {
        left: { id: "m5-l2", text: "BYD" },
        right: { id: "m5-r2", text: "China" },
      },
      {
        left: { id: "m5-l3", text: "Koenigsegg" },
      ...
      },
      {
        ...
        right: { id: "m5-r5", text: "France" },
      },
      {
        left: { id: "m5-l6", text: "Porsche" },
        right: { id: "m5-r6", text: "Germany" },
      },
      {
        left: { id: "m5-l7", text: "Hyundai" },
        right: { id: "m5-r7", text: "South Korea" },
      },
      {
        left: { id: "m5-l8", text: "Fiat" },
      ...
      },
      {
        ...
        right: { id: "m5-r10", text: "United Kingdom" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m6-l1", text: "Carmen" },
        right: { id: "m6-r1", text: "Georges Bizet" },
      },
      {
        left: { id: "m6-l2", text: "The Marriage of Figaro" },
      ...
      {
        left: { id: "m6-l5", text: "Eugene Onegin" },
        right: { id: "m6-r5", text: "Tchaikovsky" },
      },
      {
        left: { id: "m6-l6", text: "The Phantom of the Opera" },
        right: { id: "m6-r6", text: "Andrew Lloyd Webber" },
      },
      {
        left: { id: "m6-l7", text: "Chess" },
        right: { id: "m6-r7", text: "Björn & Benny" },
      },
      {
        left: { id: "m6-l8", text: "The Barber of Seville" },
      ...
      },
      {
        ...
        right: { id: "m6-r10", text: "Richard Wagner" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m7-l1", text: "Australia" },
        right: { id: "m7-r1", text: "Canberra" },
      },
      {
        left: { id: "m7-l2", text: "Cambodia" },
        right: { id: "m7-r2", text: "Phnom Penh" },
      },
      {
        left: { id: "m7-l3", text: "Turkey" },
        right: { id: "m7-r3", text: "Ankara" },
      },
      {
        left: { id: "m7-l4", text: "Niger" },
        right: { id: "m7-r4", text: "Niamey" },
      },
      {
        left: { id: "m7-l5", text: "Paraguay" },
        right: { id: "m7-r5", text: "Asunción" },
      },
      {
        left: { id: "m7-l6", text: "Nicaragua" },
        right: { id: "m7-r6", text: "Managua" },
      },
      {
        left: { id: "m7-l7", text: "Haiti" },
        right: { id: "m7-r7", text: "Port-au-Prince" },
      },
      {
        left: { id: "m7-l8", text: "Trinidad and Tobago" },
        right: { id: "m7-r8", text: "Port of Spain" },
      },
      {
        left: { id: "m7-l9", text: "Chad" },
        right: { id: "m7-r9", text: "N'Djamena" },
      },
      {
        left: { id: "m7-l10", text: "Bhutan" },
        right: { id: "m7-r10", text: "Thimphu" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m8-l1", text: "Isaac Newton" },
        right: { id: "m8-r1", text: "Laws of Motion" },
      },
      {
        left: { id: "m8-l2", text: "Albert Einstein" },
        right: { id: "m8-r2", text: "Theory of Relativity" },
      },
      {
        left: { id: "m8-l3", text: "Marie Curie" },
        right: { id: "m8-r3", text: "Radioactivity" },
      },
      {
        left: { id: "m8-l4", text: "Charles Darwin" },
        right: { id: "m8-r4", text: "Theory of Evolution" },
      },
      {
        left: { id: "m8-l5", text: "Galileo Galilei" },
        right: { id: "m8-r5", text: "Heliocentric Theory" },
      },
      {
        left: { id: "m8-l6", text: "Nikola Tesla" },
        right: { id: "m8-r6", text: "Alternating Current" },
      },
      {
        left: { id: "m8-l7", text: "Louis Pasteur" },
        right: { id: "m8-r7", text: "Germ Theory" },
      },
      {
        left: { id: "m8-l8", text: "James Clerk Maxwell" },
        right: { id: "m8-r8", text: "Electromagnetic Theory" },
      },
      {
        left: { id: "m8-l9", text: "Dmitri Mendeleev" },
        right: { id: "m8-r9", text: "Periodic Table" },
      },
      {
        left: { id: "m8-l10", text: "Gregor Mendel" },
        right: { id: "m8-r10", text: "Laws of Inheritance" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m9-l1", text: "Leonardo da Vinci" },
        right: { id: "m9-r1", text: "Mona Lisa" },
      },
      {
        left: { id: "m9-l2", text: "Vincent van Gogh" },
        right: { id: "m9-r2", text: "Starry Night" },
      },
      {
        left: { id: "m9-l3", text: "Pablo Picasso" },
        right: { id: "m9-r3", text: "Guernica" },
      },
      {
        left: { id: "m9-l4", text: "Claude Monet" },
        right: { id: "m9-r4", text: "Water Lilies" },
      },
      {
        left: { id: "m9-l5", text: "Salvador Dalí" },
        right: { id: "m9-r5", text: "The Persistence of Memory" },
      },
      {
        left: { id: "m9-l6", text: "Edvard Munch" },
        right: { id: "m9-r6", text: "The Scream" },
      },
      {
        left: { id: "m9-l7", text: "Johannes Vermeer" },
        right: { id: "m9-r7", text: "Girl with a Pearl Earring" },
      },
      {
        left: { id: "m9-l8", text: "Michelangelo" },
        right: { id: "m9-r8", text: "The Creation of Adam" },
      },
      {
        left: { id: "m9-l9", text: "Rembrandt" },
        right: { id: "m9-r9", text: "The Night Watch" },
      },
      {
        left: { id: "m9-l10", text: "Gustav Klimt" },
        right: { id: "m9-r10", text: "The Kiss" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m10-l1", text: "The Legend of Zelda" },
        right: { id: "m10-r1", text: "Link" },
      },
      {
        left: { id: "m10-l2", text: "The Last of Us" },
        right: { id: "m10-r2", text: "Joel" },
      },
      {
        left: { id: "m10-l3", text: "Halo" },
        right: { id: "m10-r3", text: "Master Chief" },
      },
      {
        left: { id: "m10-l4", text: "Tomb Raider" },
        right: { id: "m10-r4", text: "Lara Croft" },
      },
      {
        left: { id: "m10-l5", text: "Final Fantasy VII" },
        right: { id: "m10-r5", text: "Cloud Strife" },
      },
      {
        left: { id: "m10-l6", text: "Resident Evil" },
        right: { id: "m10-r6", text: "Jill Valentine" },
      },
      {
        left: { id: "m10-l7", text: "Metal Gear Solid" },
        right: { id: "m10-r7", text: "Solid Snake" },
      },
      {
        left: { id: "m10-l8", text: "God of War" },
        right: { id: "m10-r8", text: "Kratos" },
      },
      {
        left: { id: "m10-l9", text: "Assassin's Creed" },
        right: { id: "m10-r9", text: "Ezio Auditore" },
      },
      {
        left: { id: "m10-l10", text: "Overwatch" },
        right: { id: "m10-r10", text: "Tracer" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m11-l1", text: "Matrix" },
        right: { id: "m11-r1", text: "Movie" },
      },
      {
        left: { id: "m11-l2", text: "Miraculix" },
        right: { id: "m11-r2", text: "Character in Asterix" },
      },
      {
        left: { id: "m11-l3", text: "Helix" },
        right: { id: "m11-r3", text: "DNA structure" },
      },
      {
        left: { id: "m11-l4", text: "Appendix" },
        right: { id: "m11-r4", text: "Body part" },
      },
      {
        left: { id: "m11-l5", text: "Calyx" },
        right: { id: "m11-r5", text: "Part of a flower" },
      },
      {
        left: { id: "m11-l6", text: "Dominatrix" },
        right: { id: "m11-r6", text: "Person in control" },
      },
      {
        left: { id: "m11-l7", text: "Transfix" },
        right: { id: "m11-r7", text: "Verb" },
      },
      {
        left: { id: "m11-l8", text: "Crucifix" },
        right: { id: "m11-r8", text: "Religious symbol" },
      },
      {
        left: { id: "m11-l9", text: "Suffix" },
        right: { id: "m11-r9", text: "Word ending" },
      },
      {
        left: { id: "m11-l10", text: "Phoenix Wright" },
        right: { id: "m11-r10", text: "Video game character" },
      },
    ],
  },
  {
    ...
    pairs: [
      {
        left: { id: "m12-l1", text: "Roxanne" },
        right: { id: "m12-r1", text: "The Police" },
      },
      {
        left: { id: "m12-l2", text: "Jolene" },
        right: { id: "m12-r2", text: "Dolly Parton" },
      },
      {
        left: { id: "m12-l3", text: "Billie Jean" },
      ...
      {
        left: { id: "m12-l5", text: "Sweet Caroline" },
        right: { id: "m12-r5", text: "Neil Diamond" },
      },
      {
        left: { id: "m12-l6", text: "Angie" },
      ...
      },
      {
        ...
        right: { id: "m12-r8", text: "Derek and the Dominos" },
      },
      {
        left: { id: "m12-l9", text: "Mandy" },
        right: { id: "m12-r9", text: "Barry Manilow" },
      },
      {
        left: { id: "m12-l10", text: "Rhiannon" },
        right: { id: "m12-r10", text: "Fleetwood Mac" },
      },
    ],
  },
];
...
export function toPublicMatchingBoard(
  board: MatchingBoardBankItem,
): MatchingBoard {
  return {
    title: board.title,
